---
name: snsweb-firebase-security
version: 1.0.0
description: Firebase 보안 규칙 (Security Rules) 개발 가이드 문서의 SED 사양
author: JaeHo Song
...
## Overview
- 이 문서는 "Firebase 보안 규칙 (Security Rules) 개발 가이드"에 대한 세부 사양을 정리하며, 기존 내용을 그대로 유지한 채 SED 구조에 맞춰 제공합니다.
