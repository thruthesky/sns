 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _=function(n,e){if(!n)throw wn(e)},wn=function(n){return new Error("Firebase Database ("+Cl.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function En(n){try{return(n.startsWith("http://")||n.startsWith("https://")?new URL(n).hostname:n).endsWith(".cloudworkstations.dev")}catch{return!1}}async function Nl(n){return(await fetch(n,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Uf="FirebaseError";class wt extends Error{constructor(e,t,s){super(t),this.code=e,this.customData=s,this.name=Uf,Object.setPrototypeOf(this,wt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,ns.prototype.create)}}class ns{constructor(e,t,s){this.service=e,this.serviceName=t,this.errors=s}create(e,...t){const s=t[0]||{},i=`${this.service}/${e}`,r=this.errors[e],o=r?$f(r,s):"Error",a=`${this.serviceName}: ${o} (${i}).`;return new wt(i,a,s)}}function $f(n,e){return n.replace(Wf,(t,s)=>{const i=e[s];return i!=null?String(i):`<${s}?>`})}const Wf=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sn(n,e,t=!1){if(t)return e;try{return await e}catch(s){throw s instanceof wt&&v_(s)&&n.auth.currentUser===n&&await n.auth.signOut(),s}}function v_({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fi(n){const e=n.auth,t=await n.getIdToken(),s=await Sn(n,di(e,{idToken:t}));w(s?.users.length,e,"internal-error");const i=s.users[0];n._notifyReloadListener(i);const r=i.providerUserInfo?.length?rc(i.providerUserInfo):[],o=E_(n.providerData,r),a=n.isAnonymous,l=!(n.email&&i.passwordHash)&&!o?.length,c=a?l:!1,h={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:o,metadata:new Jr(i.createdAt,i.lastLoginAt),isAnonymous:c};Object.assign(n,h)}async function w_(n){const e=te(n);await fi(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function E_(n,e){return[...n.filter(s=>!e.some(i=>i.providerId===s.providerId)),...e]}function rc(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rn{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){w(e.idToken,"internal-error"),w(typeof e.idToken<"u","internal-error"),w(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):ic(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){w(e.length!==0,"internal-error");const t=ic(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(w(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:s,refreshToken:i,expiresIn:r}=await I_(e,t);this.updateTokensAndExpiration(s,i,Number(r))}updateTokensAndExpiration(e,t,s){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+s*1e3}static fromJSON(e,t){const{refreshToken:s,accessToken:i,expirationTime:r}=t,o=new Rn;return s&&(w(typeof s=="string","internal-error",{appName:e}),o.refreshToken=s),i&&(w(typeof i=="string","internal-error",{appName:e}),o.accessToken=i),r&&(w(typeof r=="number","internal-error",{appName:e}),o.expirationTime=r),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new Rn,this.toJSON())}_performRefresh(){return ct("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $_(n,e){const t=zr(n,"auth");if(t.isInitialized()){const i=t.getImmediate(),r=t.getOptions();if(jt(r,e??{}))return i;Fe(i,"already-initialized")}return t.initialize({options:e})}function W_(n,e){const t=e?.persistence||[],s=(Array.isArray(t)?t:[t]).map(dt);e?.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(s,e?.popupRedirectResolver)}function B_(n,e,t){const s=Kt(n);w(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const i=!1,r=Cc(e),{host:o,port:a}=H_(e),l=a===null?"":`:${a}`,c={url:`${r}//${o}${l}/`},h=Object.freeze({host:o,port:a,protocol:r.replace(":",""),options:Object.freeze({disableWarnings:i})});if(!s._canInitEmulator){w(s.config.emulator&&s.emulatorConfig,s,"emulator-config-failed"),w(jt(c,s.config.emulator)&&jt(h,s.emulatorConfig),s,"emulator-config-failed");return}s.config.emulator=c,s.emulatorConfig=h,s.settings.appVerificationDisabledForTesting=!0,En(o)?(Nl(`${r}//${o}${l}`),Ol("Auth",!0)):V_()}function Cc(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function H_(n){const e=Cc(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const s=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(s);if(i){const r=i[1];return{host:r,port:bc(s.substr(r.length+1))}}else{const[r,o]=s.split(":");return{host:r,port:bc(o)}}}function bc(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function V_(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nn{constructor(){this.providerId=Nn.PROVIDER_ID}static credential(e,t){return us._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const s=to.parseLink(t);return w(s,"argument-error"),us._fromEmailAndCode(e,s.code,s.tenantId)}}Nn.PROVIDER_ID="password",Nn.EMAIL_PASSWORD_SIGN_IN_METHOD="password",Nn.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bg(n,e){return e?dt(e):(w(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ag="pendingRedirect",Ei=new Map;class Ng extends Wc{constructor(e,t,s=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,s),this.eventId=null}async execute(){let e=Ei.get(this.auth._key());if(!e){try{const s=await Pg(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(s)}catch(t){e=()=>Promise.reject(t)}Ei.set(this.auth._key(),e)}return this.bypassAuthState||Ei.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Pg(n,e){const t=xg(e),s=Dg(n);if(!await s._isAvailable())return!1;const i=await s._get(t)==="true";return await s._remove(t),i}function Og(n,e){Ei.set(n._key(),e)}function Dg(n){return dt(n._redirectPersistence)}function xg(n){return pi(Ag,n.config.apiKey,n.name)}async function Mg(n,e,t=!1){if(ke(n.app))return Promise.reject(lt(n));const s=Kt(n),i=bg(s,e),o=await new Ng(s,i,t).execute();return o&&!t&&(delete o.user._redirectEventId,await s._persistUserIfCurrent(o.user),await s._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const am="__/auth/handler",lm="emulator/auth/handler",cm=encodeURIComponent("fac");async function jc(n,e,t,s,i,r){w(n.config.authDomain,n,"auth-domain-config-required"),w(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:s,v:Tn,eventId:i};if(e instanceof Tc){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",Or(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[h,d]of Object.entries({}))o[h]=d}if(e instanceof hs){const h=e.getScopes().filter(d=>d!=="");h.length>0&&(o.scopes=h.join(","))}n.tenantId&&(o.tid=n.tenantId);const a=o;for(const h of Object.keys(a))a[h]===void 0&&delete a[h];const l=await n._getAppCheckToken(),c=l?`#${cm}=${encodeURIComponent(l)}`:"";return`${um(n)}?${Cn(a).slice(1)}${c}`}function um({config:n}){return n.emulator?Kr(n,lm):`https://${n.authDomain}/${am}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xc=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Em(e)}}catch{}return new Im},Jt=Xc("localStorage"),Cm=Xc("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ri;class Mu extends Si{static get __EMPTY_NODE(){return Ri}static set __EMPTY_NODE(e){Ri=e}compare(e,t){return Zt(e.name,t.name)}isDefinedOn(e){throw wn("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return b.MIN}maxPost(){return new b(Xt,Ri)}makePost(e,t){return _(typeof e=="string","KeyIndex indexValue must always be a string."),new b(e,Ri)}toString(){return".key"}}const Ln=new Mu;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yv(n,e){return Zt(n.name,e.name)}function wo(n,e){return Zt(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Eo;function wv(n){Eo=n}const Lu=function(n){return typeof n=="number"?"number:"+nu(n):"string:"+n},Fu=function(n){if(n.isLeafNode()){const e=n.val();_(typeof e=="string"||typeof e=="number"||typeof e=="object"&&Qe(e,".sv"),"Priority must be a string or number.")}else _(n===Eo||n.isEmpty(),"priority of unexpected type.");_(n===Eo||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rv=!0;function Q(n,e=null){if(n===null)return E.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),_(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new Z(t,Q(e))}if(!(n instanceof Array)&&Rv){const t=[];let s=!1;if(se(n,(o,a)=>{if(o.substring(0,1)!=="."){const l=Q(a);l.isEmpty()||(s=s||!l.getPriority().isEmpty(),t.push(new b(o,l)))}}),t.length===0)return E.EMPTY_NODE;const r=Ai(t,yv,o=>o.name,wo);if(s){const o=Ai(t,G.getCompare());return new E(r,Q(e),new _t({".priority":o},{".priority":G}))}else return new E(r,Q(e),_t.Default)}else{let t=E.EMPTY_NODE;return se(n,(s,i)=>{if(Qe(n,s)&&s.substring(0,1)!=="."){const r=Q(i);(r.isLeafNode()||!r.isEmpty())&&(t=t.updateImmediateChild(s,r))}}),t.updatePriority(Q(e))}}Ev(Q);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ts{constructor(e){this.indexedFilter_=new Co(e.getIndex()),this.index_=e.getIndex(),this.startPost_=Ts.getStartPost_(e),this.endPost_=Ts.getEndPost_(e),this.startIsInclusive_=!e.startAfterSet_,this.endIsInclusive_=!e.endBeforeSet_}getStartPost(){return this.startPost_}getEndPost(){return this.endPost_}matches(e){const t=this.startIsInclusive_?this.index_.compare(this.getStartPost(),e)<=0:this.index_.compare(this.getStartPost(),e)<0,s=this.endIsInclusive_?this.index_.compare(e,this.getEndPost())<=0:this.index_.compare(e,this.getEndPost())<0;return t&&s}updateChild(e,t,s,i,r,o){return this.matches(new b(t,s))||(s=E.EMPTY_NODE),this.indexedFilter_.updateChild(e,t,s,i,r,o)}updateFullNode(e,t,s){t.isLeafNode()&&(t=E.EMPTY_NODE);let i=t.withIndex(this.index_);i=i.updatePriority(E.EMPTY_NODE);const r=this;return t.forEachChild(G,(o,a)=>{r.matches(new b(o,a))||(i=i.updateImmediateChild(o,E.EMPTY_NODE))}),this.indexedFilter_.updateFullNode(e,i,s)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.indexedFilter_}getIndex(){return this.index_}static getStartPost_(e){if(e.hasStart()){const t=e.getIndexStartName();return e.getIndex().makePost(e.getIndexStartValue(),t)}else return e.getIndex().minPost()}static getEndPost_(e){if(e.hasEnd()){const t=e.getIndexEndName();return e.getIndex().makePost(e.getIndexEndValue(),t)}else return e.getIndex().maxPost()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xv{constructor(){this.rootNode_=E.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zo{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new zo(t)}node(){return this.node_}}class jo{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=j(this.path_,e);return new jo(this.syncTree_,t)}node(){return Wo(this.syncTree_,this.path_)}}const $y=function(n){return n=n||{},n.timestamp=n.timestamp||new Date().getTime(),n},wh=function(n,e,t){if(!n||typeof n!="object")return n;if(_(".sv"in n,"Unexpected leaf node or priority contents"),typeof n[".sv"]=="string")return Wy(n[".sv"],e,t);if(typeof n[".sv"]=="object")return By(n[".sv"],e);_(!1,"Unexpected server value: "+JSON.stringify(n,null,2))},Wy=function(n,e,t){switch(n){case"timestamp":return t.timestamp;default:_(!1,"Unexpected server value: "+n)}},By=function(n,e,t){n.hasOwnProperty("increment")||_(!1,"Unexpected server value: "+JSON.stringify(n,null,2));const s=n.increment;typeof s!="number"&&_(!1,"Unexpected increment value: "+s);const i=e.node();if(_(i!==null&&typeof i<"u","Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return s;const o=i.getValue();return typeof o!="number"?s:o+s},Eh=function(n,e,t,s){return Go(e,new jo(t,n),s)},Ih=function(n,e,t){return Go(n,new zo(e),t)};function Go(n,e,t){const s=n.getPriority().val(),i=wh(s,e.getImmediateChild(".priority"),t);let r;if(n.isLeafNode()){const o=n,a=wh(o.getValue(),e,t);return a!==o.getValue()||i!==o.getPriority().val()?new Z(a,Q(i)):n}else{const o=n;return r=o,i!==o.getPriority().val()&&(r=r.updatePriority(new Z(i))),o.forEachChild(G,(a,l)=>{const c=Go(l,e.getImmediateChild(a),t);c!==l&&(r=r.updateImmediateChild(a,c))}),r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zy{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Gi(n,e){let t=null;for(let s=0;s<e.length;s++){const i=e[s],r=i.getPath();t!==null&&!vo(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(i)}t&&n.eventLists_.push(t)}function Ah(n,e,t){Gi(n,t),Nh(n,s=>vo(s,e))}function Ne(n,e,t){Gi(n,t),Nh(n,s=>Ae(s,e)||Ae(e,s))}function Nh(n,e){n.recursionDepth_++;let t=!0;for(let s=0;s<n.eventLists_.length;s++){const i=n.eventLists_[s];if(i){const r=i.path;e(r)?(ew(n.eventLists_[s]),n.eventLists_[s]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function ew(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const s=t.getEventRunner();ps&&ne("event: "+t.toString()),xn(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pw(n){let e="";const t=n.split("/");for(let s=0;s<t.length;s++)if(t[s].length>0){let i=t[s];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch{}e+="/"+i}return e}function _w(n){const e={};n.charAt(0)==="?"&&(n=n.substring(1));for(const t of n.split("&")){if(t.length===0)continue;const s=t.split("=");s.length===2?e[decodeURIComponent(s[0])]=decodeURIComponent(s[1]):fe(`Invalid query segment '${t}' in query '${n}'`)}return e}const Uh=function(n,e){const t=gw(n),s=t.namespace;t.domain==="firebase.com"&&ft(t.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!s||s==="undefined")&&t.domain!=="localhost"&&ft("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),t.secure||Sm();const i=t.scheme==="ws"||t.scheme==="wss";return{repoInfo:new fu(t.host,t.secure,s,i,e,"",s!==t.subdomain),path:new L(t.pathString)}},gw=function(n){let e="",t="",s="",i="",r="",o=!0,a="https",l=443;if(typeof n=="string"){let c=n.indexOf("//");c>=0&&(a=n.substring(0,c-1),n=n.substring(c+2));let h=n.indexOf("/");h===-1&&(h=n.length);let d=n.indexOf("?");d===-1&&(d=n.length),e=n.substring(0,Math.min(h,d)),h<d&&(i=pw(n.substring(h,d)));const u=_w(n.substring(Math.min(n.length,d)));c=e.indexOf(":"),c>=0?(o=a==="https"||a==="wss",l=parseInt(e.substring(c+1),10)):c=e.length;const f=e.slice(0,c);if(f.toLowerCase()==="localhost")t="localhost";else if(f.split(".").length<=2)t=f;else{const p=e.indexOf(".");s=e.substring(0,p).toLowerCase(),t=e.substring(p+1),r=s}"ns"in u&&(r=u.ns)}return{host:e,port:l,domain:t,subdomain:s,secure:o,scheme:a,pathString:i,namespace:r}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vw{constructor(e,t,s,i){this.eventType=e,this.eventRegistration=t,this.snapshot=s,this.prevName=i}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+Y(this.snapshot.exportVal())}}class yw{constructor(e,t,s){this.eventRegistration=e,this.error=t,this.path=s}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oa{constructor(e,t,s,i){this._repo=e,this._path=t,this._queryParams=s,this._orderByCalled=i}get key(){return S(this._path)?null:mo(this._path)}get ref(){return new gt(this._repo,this._path)}get _queryIdentifier(){const e=Vu(this._queryParams),t=lo(e);return t==="{}"?"default":t}get _queryObject(){return Vu(this._queryParams)}isEqual(e){if(e=te(e),!(e instanceof oa))return!1;const t=this._repo===e._repo,s=vo(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+cv(this._path)}}class gt extends oa{constructor(e,t){super(e,t,new bo,!1)}get parent(){const e=Pu(this._path);return e===null?null:new gt(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Ms{constructor(e,t,s){this._node=e,this.ref=t,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new L(e),s=Ls(this.ref,e);return new Ms(this._node.getChild(t),s,G)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new Ms(i,Ls(this.ref,s),G)))}hasChild(e){const t=new L(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Ze(n,e){return n=te(n),n._checkNotDeleted("ref"),e!==void 0?Ls(n._root,e):n._root}function Ls(n,e){return n=te(n),C(n._path)===null?Jy("child","path",e):kh("child","path",e),new gt(n._repo,j(n._path,e))}function ww(n,e){n=te(n),Xo("push",n._path),Rh("push",e,n._path,!0);const t=Ph(n._repo),s=mw(t),i=Ls(n,s),r=Ls(n,s);let o;return o=Promise.resolve(r),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function Ew(n){return Xo("remove",n._path),Yi(n,null)}function Yi(n,e){n=te(n),Xo("set",n._path),Rh("set",e,n._path,!1);const t=new es;return aw(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function aa(n,e){Qy("update",e,n._path);const t=new es;return lw(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}function Iw(n){n=te(n);const e=new Wh(()=>{}),t=new Qi(e);return ow(n._repo,n,t).then(s=>new Ms(s,new gt(n._repo,n._path),n._queryParams.getIndex()))}class Qi{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const s=t._queryParams.getIndex();return new vw("value",this,new Ms(e.snapshotNode,new gt(t._repo,t._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new yw(this,e,t):null}matches(e){return e instanceof Qi?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function Cw(n,e,t,s,i){let r;if(typeof s=="object"&&(r=void 0,i=s),typeof s=="function"&&(r=s),i&&i.onlyOnce){const l=t,c=(h,d)=>{ta(n._repo,n,a),l(h,d)};c.userCallback=t.userCallback,c.context=t.context,t=c}const o=new Wh(t,r||void 0),a=new Qi(o);return uw(n._repo,n,a),()=>ta(n._repo,n,a)}function Ji(n,e,t,s){return Cw(n,"value",e,t,s)}function la(n,e,t){ta(n._repo,n,null)}Ey(gt),Sy(gt);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bw="FIREBASE_DATABASE_EMULATOR_HOST",ca={};let Tw=!1;function Sw(n,e,t,s){const i=e.lastIndexOf(":"),r=e.substring(0,i),o=En(r);n.repoInfo_=new fu(e,o,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0,t),s&&(n.authTokenProvider_=s)}function Rw(n,e,t,s,i){let r=s||n.options.databaseURL;r===void 0&&(n.options.projectId||ft("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),ne("Using default host for project ",n.options.projectId),r=`${n.options.projectId}-default-rtdb.firebaseio.com`);let o=Uh(r,i),a=o.repoInfo,l;typeof process<"u"&&process.env&&(l=process.env[bw]),l?(r=`http://${l}?ns=${a.namespace}`,o=Uh(r,i),a=o.repoInfo):o.repoInfo.secure;const c=new Fm(n.name,n.options,e);Xy("Invalid Firebase Database URL",o),S(o.path)||ft("Database URL must point to the root of a Firebase Database (not including a child path).");const h=Aw(a,n,c,new Lm(n,t));return new Nw(h,n)}function kw(n,e){const t=ca[e];(!t||t[n.key]!==n)&&ft(`Database ${e}(${n.repoInfo_}) has already been deleted.`),hw(n),delete t[n.key]}function Aw(n,e,t,s){let i=ca[e.name];i||(i={},ca[e.name]=i);let r=i[n.toURLString()];return r&&ft("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new sw(n,Tw,t,s),i[n.toURLString()]=r,r}class Nw{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(iw(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new gt(this._repo,k())),this._rootInternal}_delete(){return this._rootInternal!==null&&(kw(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&ft("Cannot call "+e+" on a deleted database.")}}function Pw(n=zl(),e){const t=zr(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const s=kf("database");s&&Ow(t,...s)}return t}function Ow(n,e,t,s={}){n=te(n),n._checkNotDeleted("useEmulator");const i=`${e}:${t}`,r=n._repoInternal;if(n._instanceStarted){if(i===n._repoInternal.repoInfo_.host&&jt(s,r.repoInfo_.emulatorOptions))return;ft("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let o;if(r.repoInfo_.nodeAdmin)s.mockUserToken&&ft('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new Ci(Ci.OWNER);else if(s.mockUserToken){const a=typeof s.mockUserToken=="string"?s.mockUserToken:Af(s.mockUserToken,n.app.options.projectId);o=new Ci(a)}En(e)&&(Nl(e),Ol("Database",!0)),Sw(r,i,s,o)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dw(n){wm(Tn),bn(new Gt("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Rw(s,i,r,t)},"PUBLIC").setMultipleInstances(!0)),Ct(Yc,Qc,n),Ct(Yc,Qc,"esm2020")}pt.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)},pt.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)},Dw();const Bh=Vl({apiKey:"AIzaSyB89ImXbiKosw6eTCC8S1_vY8BzGq_SFY0",authDomain:"withcenter-test-5.firebaseapp.com",databaseURL:"https://withcenter-test-5-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"withcenter-test-5",storageBucket:"withcenter-test-5.appspot.com",messagingSenderId:"1064417466216",appId:"1:1064417466216:web:039565a60d9b0b74db28dd"}),Fs=vm(Bh),He=Pw(Bh),Hh=kr(null),Vh=kr(!0);ag(Fs,n=>{Hh.set(n),Vh.set(!1)});async function zh(n,e){try{return await ng(Fs,n,e),{success:!0}}catch(t){return console.error("로그인 오류:",t),{success:!1,error:Gh(t.code)}}}async function jh(n,e,t=""){try{const s=await tg(Fs,n,e);return t&&await ig(s.user,{displayName:t}),{success:!0}}catch(s){return console.error("회원가입 오류:",s),{success:!1,error:Gh(s.code)}}}async function xw(){try{return await lg(Fs),{success:!0}}catch(n){return console.error("로그아웃 오류:",n),{success:!1,error:n.message}}}function Gh(n){return{"auth/invalid-email":"유효하지 않은 이메일 주소입니다.","auth/user-disabled":"비활성화된 계정입니다.","auth/user-not-found":"등록되지 않은 이메일입니다.","auth/wrong-password":"잘못된 비밀번호입니다.","auth/email-already-in-use":"이미 사용 중인 이메일입니다.","auth/weak-password":"비밀번호는 최소 6자 이상이어야 합니다.","auth/too-many-requests":"너무 많은 요청이 발생했습니다. 잠시 후 다시 시도해주세요.","auth/network-request-failed":"네트워크 연결을 확인해주세요.","auth/invalid-credential":"인증 정보가 올바르지 않습니다."}[n]||"알 수 없는 오류가 발생했습니다."}var Mw=Me('<div class="form-group svelte-16585sj"><label for="displayName" class="label svelte-16585sj">이름</label> <input id="displayName" type="text" required placeholder="이름을 입력하세요" class="input svelte-16585sj"/></div>'),Lw=Me('<div class="error-message svelte-16585sj"> </div>'),Fw=Me('<div class="login-container svelte-16585sj"><div class="login-card svelte-16585sj"><h2 class="title svelte-16585sj"> </h2> <form class="form svelte-16585sj"><!> <div class="form-group svelte-16585sj"><label for="email" class="label svelte-16585sj">이메일</label> <input id="email" type="email" required placeholder="email@example.com" class="input svelte-16585sj"/></div> <div class="form-group svelte-16585sj"><label for="password" class="label svelte-16585sj">비밀번호</label> <input id="password" type="password" required placeholder="비밀번호 (최소 6자)" minlength="6" class="input svelte-16585sj"/></div> <!> <button type="submit" class="submit-button svelte-16585sj"> </button> <button type="button" class="toggle-button svelte-16585sj"> </button></form></div></div>');const Uw={hash:"svelte-16585sj",code:`
  ...
  /* 모드 전환 버튼 */.toggle-button.svelte-16585sj {padding:0.5rem;background:transparent;color:#007bff;border:none;font-size:0.9rem;cursor:pointer;text-decoration:underline;}.toggle-button.svelte-16585sj:hover:not(:disabled) {color:#0056b3;}.toggle-button.svelte-16585sj:disabled {color:#ccc;cursor:not-allowed;}`};function $w(n,e){lr(e,!0),vl(n,Uw);let t=ee(""),s=ee(""),i=ee(""),r=ee(""),o=ee(!1),a=ee(!1);async function l(q){q.preventDefault(),D(o,!0),D(r,"");let W;if(y(a)?W=await jh(y(t),y(s),y(i)):W=await zh(y(t),y(s)),W.success){const re=new CustomEvent("login-success",{detail:{email:y(t)},bubbles:!0,composed:!0});dispatchEvent(re),D(t,""),D(s,""),D(i,"")}else{D(r,W.error,!0);const re=new CustomEvent("login-error",{detail:{error:W.error},bubbles:!0,composed:!0});dispatchEvent(re)}D(o,!1)}function c(){D(a,!y(a)),D(r,"")}var h=Fw(),d=V(h),u=V(d),f=V(u,!0);B(u);var p=ve(u,2),g=V(p);{var v=q=>{var W=Mw(),re=ve(V(W),2);Cr(re),B(W),Bt(()=>re.disabled=y(o)),Tr(re,()=>y(i),rn=>D(i,rn)),we(q,W)};zt(g,q=>{y(a)&&q(v)})}var N=ve(g,2),m=ve(V(N),2);Cr(m),B(N);var I=ve(N,2),P=ve(V(I),2);Cr(P),B(I);var x=ve(I,2);{var ie=q=>{var W=Lw(),re=V(W,!0);B(W),Bt(()=>Le(re,y(r))),we(q,W)};zt(x,q=>{y(r)&&q(ie)})}var $=ve(x,2),J=V($,!0);B($);var z=ve($,2);z.__click=c;var Ve=V(z,!0);B(z),B(p),B(d),B(h),Bt(()=>{Le(f,y(a)?"회원가입":"로그인"),m.disabled=y(o),P.disabled=y(o),$.disabled=y(o),Le(J,y(o)?"처리 중...":y(a)?"회원가입":"로그인"),z.disabled=y(o),Le(Ve,y(a)?"이미 계정이 있으신가요? 로그인":"계정이 없으신가요? 회원가입")}),ef("submit",p,l),Tr(m,()=>y(t),q=>D(t,q)),Tr(P,()=>y(s),q=>D(s,q)),we(n,h),cr()}hl(["click"]),customElements.define("login-form",Il($w,{},[],[],!0));var Ww=Me('<div class="loading svelte-1t1odzy"><div class="spinner svelte-1t1odzy"></div> <p class="svelte-1t1odzy">게시물을 불러오는 중...</p></div>'),Bw=Me('<div class="error svelte-1t1odzy"><p class="svelte-1t1odzy"> </p></div>'),Hw=Me('<div class="empty svelte-1t1odzy"><p class="svelte-1t1odzy">아직 게시물이 없습니다.</p></div>'),Vw=Me('<h3 class="post-title svelte-1t1odzy"> </h3>'),zw=Me('<p class="post-text svelte-1t1odzy"> </p>'),jw=Me('<article class="post-card svelte-1t1odzy" role="button" tabindex="0"><div class="post-header svelte-1t1odzy"><div class="author-info svelte-1t1odzy"><span class="author-name svelte-1t1odzy"> </span> <span class="post-date svelte-1t1odzy"> </span></div></div> <div class="post-content svelte-1t1odzy"><!> <!></div> <div class="post-footer svelte-1t1odzy"><span class="stat svelte-1t1odzy"> </span> <span class="stat svelte-1t1odzy"> </span></div></article>'),Gw=Me('<div class="posts svelte-1t1odzy"></div>'),qw=Me('<div class="post-list-container svelte-1t1odzy"><!></div>');const Kw={hash:"svelte-1t1odzy",code:`
  ...
  }`};function Yw(n,e){lr(e,!0),vl(n,Kw);let t=wl(e,"path",7,"posts"),s=wl(e,"limit",7,"10"),i=ee(pn([])),r=ee(!0),o=ee(""),a=null;gl(()=>{l()}),lf(()=>{c()});function l(){try{a=Ze(He,t()),Ji(a,m=>{const I=m.val();I?D(i,Object.entries(I).map(([P,x])=>({id:P,...x})).sort((P,x)=>(x.timestamp||0)-(P.timestamp||0)).slice(0,parseInt(s())),!0):D(i,[],!0),D(r,!1),D(o,"")},m=>{console.error("데이터 읽기 오류:",m),D(o,"데이터를 불러오는 중 오류가 발생했습니다."),D(r,!1)})}catch(m){console.error("구독 설정 오류:",m),D(o,"데이터베이스 연결에 실패했습니다."),D(r,!1)}}function c(){a&&la(a)}function h(m){const I=new CustomEvent("post-click",{detail:{post:m},bubbles:!0,composed:!0});dispatchEvent(I)}function d(m,I){(m.key==="Enter"||m.key===" ")&&(m.preventDefault(),h(I))}function u(m){if(!m)return"";const I=typeof m=="string"?Number(m):m,P=new Date(I),ie=new Date().getTime()-P.getTime(),$=Math.floor(ie/6e4),J=Math.floor(ie/36e5),z=Math.floor(ie/864e5);return $<1?"방금 전":$<60?`${$}분 전`:J<24?`${J}시간 전`:z<7?`${z}일 전`:P.toLocaleDateString("ko-KR",{year:"numeric",month:"long",day:"numeric"})}var f={get path(){return t()},set path(m="posts"){t(m),Js()},get limit(){return s()},set limit(m="10"){s(m),Js()}},p=qw(),g=V(p);{var v=m=>{var I=Ww();we(m,I)},N=m=>{var I=fl(),P=Va(I);{var x=$=>{var J=Bw(),z=V(J),Ve=V(z,!0);B(z),B(J),Bt(()=>Le(Ve,y(o))),we($,J)},ie=$=>{var J=fl(),z=Va(J);{var Ve=W=>{var re=Hw();we(W,re)},q=W=>{var re=Gw();uf(re,21,()=>y(i),rn=>rn.id,(rn,Ie)=>{var zn=jw();zn.__click=()=>h(y(Ie)),zn.__keydown=ze=>d(ze,y(Ie));var ua=V(zn),qh=V(ua),ha=V(qh),sE=V(ha,!0);B(ha);var Kh=ve(ha,2),iE=V(Kh,!0);B(Kh),B(qh),B(ua);var da=ve(ua,2),Yh=V(da);{var rE=ze=>{var on=Vw(),pa=V(on,!0);B(on),Bt(()=>Le(pa,y(Ie).title)),we(ze,on)};zt(Yh,ze=>{y(Ie).title&&ze(rE)})}var oE=ve(Yh,2);{var aE=ze=>{var on=zw(),pa=V(on,!0);B(on),Bt(()=>Le(pa,y(Ie).content)),we(ze,on)};zt(oE,ze=>{y(Ie).content&&ze(aE)})}B(da);var Qh=ve(da,2),fa=V(Qh),lE=V(fa);B(fa);var Jh=ve(fa,2),cE=V(Jh);B(Jh),B(Qh),B(zn),Bt(ze=>{br(zn,"aria-label",`게시물: ${(y(Ie).title||y(Ie).content||"제목 없음")??""}`),Le(sE,y(Ie).author||"익명"),Le(iE,ze),Le(lE,`👍 ${(y(Ie).likes||0)??""}`),Le(cE,`💬 ${(y(Ie).comments?.length||0)??""}`)},[()=>u(y(Ie).timestamp)]),we(rn,zn)}),B(re),we(W,re)};zt(z,W=>{y(i).length===0?W(Ve):W(q,!1)},!0)}we($,J)};zt(P,$=>{y(o)?$(x):$(ie,!1)},!0)}we(m,I)};zt(g,m=>{y(r)?m(v):m(N,!1)})}return B(p),we(n,p),cr(f)}hl(["click","keydown"]),customElements.define("post-list",Il(Yw,{path:{},limit:{}},[],[],!0));function Qw(n){const{subscribe:e,set:t}=kr(null),s=Ze(He,n);return Ji(s,i=>{const r=i.val();t(r)}),{subscribe:e,unsubscribe:()=>la(s)}}async function Jw(n,e){try{const t=Ze(He,n);return await Yi(t,e),{success:!0}}catch(t){return console.error("데이터 쓰기 오류:",t),{success:!1,error:t.message}}}async function Xw(n,e){try{const t=Ze(He,n);return await aa(t,e),{success:!0}}catch(t){return console.error("데이터 업데이트 오류:",t),{success:!1,error:t.message}}}async function Zw(n){try{const e=Ze(He,n);return await Ew(e),{success:!0}}catch(e){return console.error("데이터 삭제 오류:",e),{success:!1,error:e.message}}}async function eE(n,e){try{const t=Ze(He,n),s=ww(t);return await Yi(s,e),{success:!0,key:s.key}}catch(t){return console.error("데이터 추가 오류:",t),{success:!1,error:t.message}}}async function tE(n){try{const e=Ze(He,n),t=await Iw(e);return t.exists()?{success:!0,data:t.val()}:{success:!0,data:null}}catch(e){return console.error("데이터 읽기 오류:",e),{success:!1,error:e.message}}}function nE(n){const e=Ze(He,`status/${n}`),t=Ze(He,".info/connected");return Ji(t,s=>{s.val()===!0&&(Yi(e,{online:!0,lastSeen:Date.now()}),Ji(Ze(He,".info/connected"),i=>{i.val()||aa(e,{online:!1,lastSeen:Date.now()})}))}),()=>{aa(e,{online:!1,lastSeen:Date.now()}),la(t)}}console.log("SNS Web Components 로드됨 ✅"),K.auth=Fs,K.createRealtimeStore=Qw,K.database=He,K.deleteData=Zw,K.loading=Vh,K.pushData=eE,K.readData=tE,K.setupPresence=nE,K.signIn=zh,K.signOut=xw,K.signUp=jh,K.updateData=Xw,K.user=Hh,K.writeData=Jw,Object.defineProperty(K,Symbol.toStringTag,{value:"Module"})}));
