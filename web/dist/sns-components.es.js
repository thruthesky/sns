...
const ce = 2, so = 4, io = 8, ht = 16, dt = 32, Ot = 64, Si = 128, oe = 1024, we = 2048, ft = 4096, Ce = 8192, it = 16384, ro = 32768, Cn = 65536, ya = 1 << 17, cd = 1 << 18, en = 1 << 19, ud = 1 << 20, ke = 256, Ys = 512, Qs = 32768, Ir = 1 << 21, oo = 1 << 22, Vt = 1 << 23, nr = Symbol("$state"), hd = Symbol("legacy props"), dd = Symbol(""), un = new class extends Error {
...
function co(n) {
  ...
  return n !== void 0 && (e.x = n), e.i = !0, Ee = e.p, n ?? /** @type {T} */
  {};
}
function Yl() {
  return !0;
...
class Le {
  ...
  process(e) {
    ...
    for (const s of e)
      this.#i(s, t);
    this.is_fork || this.#c(), this.#s > 0 || this.is_fork ? (this.#r(t.effects), this.#r(t.render_effects), this.#r(t.block_effects)) : (Ws = this, H = null, wa(t.render_effects), wa(t.effects), Ws = null, this.#l?.resolve()), De = null;
  }
  /**
  ...
  #r(e) {
    for (const t of e)
      ((t.f & we) !== 0 ? this.#o : this.#a).push(t), le(t, oe);
  }
  /**
  ...
  if (!t.has(n) && (t.add(n), n.reactions !== null))
    for (const i of n.reactions) {
      ...
      (r & ce) !== 0 ? Zl(
        ...
        t,
        s
      ) : (r & (oo | ht)) !== 0 && (r & we) === 0 && // we may have scheduled this one already
      ec(i, e, s) && (le(i, we), jt(
        /** @type {Effect} */
        i
      ));
...
function nc(n) {
  var e = ho(n);
  if (n.equals(e) || (n.v = e, n.wv = Ec()), !tn)
    if (De !== null)
      De.set(n, n.v);
    else {
      var t = (Et || (n.f & ke) !== 0) && n.deps !== null ? ft : oe;
      le(n, t);
    }
}
...
function x(n, e, t = !1) {
  ...
  (!xe || (R.f & ya) !== 0) && Yl() && (R.f & (ce | ht | oo | ya)) !== 0 && !rt?.includes(n) && Ed();
  let s = t ? hn(e) : e;
  return os(n, s);
}
function os(n, e) {
  if (!n.equals(e)) {
    ...
    var s = Le.ensure();
    s.capture(n, t), (n.f & ce) !== 0 && ((n.f & we) !== 0 && ho(
      /** @type {Derived} */
      n
    ), le(n, (n.f & ke) === 0 ? oe : ft)), n.wv = Ec(), rc(n, we), S !== null && (S.f & oe) !== 0 && (S.f & (dt | Ot)) === 0 && (be === null ? Qd([n]) : be.push(n)), !s.is_fork && br.size > 0 && !sc && Fd();
  }
  return e;
}
function Fd() {
...
function Tr() {
  if (Ea === void 0) {
    Ea = window, oc = /Firefox/.test(navigator.userAgent);
...
function Cs(n) {
  ...
  if ((e & ft) !== 0) {
    ...
    if (e & ce && (n.f &= ~Qs), t !== null) {
      var i, r, o = (e & Ys) !== 0, a = s && S !== null && !Et, l = t.length;
  ...
  if (s !== null && !rt?.includes(n))
    for (var i = 0; i < s.length; i++) {
      ...
      (r.f & ce) !== 0 ? Ic(
        ...
        e,
        !1
      ) : e === r && (t ? le(r, we) : (r.f & oe) !== 0 && le(r, ft), jt(
        /** @type {Effect} */
        r
      ));
    }
...
function Cc(n) {
  var e = ue, t = Ie, s = be, i = R, r = Et, o = rt, a = Ee, l = xe, c = zt, h = n.f;
  ue = /** @type {null | Value[]} */
  null, Ie = 0, be = null, Et = (h & ke) !== 0 && (xe || !gn || R === null), R = (h & (dt | Ot)) === 0 ? n : null, rt = null, bn(n.ctx), xe = !1, zt = ++as, n.ac !== null && (Ni(() => {
    n.ac.abort(un);
  }), n.ac = null);
  try {
    n.f |= Ir;
    ...
    if (ue !== null) {
      ...
      if (ei(n, Ie), f !== null && Ie > 0)
        ...
        n.deps = f = ue;
      if (!Et || // Deriveds that already have reactions can cleanup, so we still add them as reactions
      (h & ce) !== 0 && /** @type {import('#client').Derived} */
      n.reactions !== null)
        for (p = Ie; p < f.length; p++)
          (f[p].reactions ??= []).push(n);
    } else f !== null && Ie < f.length && (ei(n, Ie), f.length = Ie);
    if (Yl() && be !== null && !xe && f !== null && (n.f & (ce | ft | we)) === 0)
    ...
    n.f ^= Ir, ue = e, Ie = t, be = s, R = i, Et = r, rt = o, bn(a), xe = l, zt = c;
  }
}
function Jd(n, e) {
  let t = e.reactions;
...
function ls(n) {
  ...
  if ((e & it) === 0) {
    ...
    try {
      ...
      var i = Cc(n);
      n.teardown = typeof i == "function" ? i : null, n.wv = wc;
      var r;
      Wl && Td && (n.f & we) !== 0 && n.deps;
    } finally {
      gn = s, S = t;
    }
  }
...
function y(n) {
  ...
  if (R !== null && !xe) {
    ...
    if (!s && !rt?.includes(n)) {
      var i = R.deps;
      if ((R.f & Ir) !== 0)
        n.rv < as && (n.rv = as, ue === null && i !== null && i[Ie] === n ? Ie++ : ue === null ? ue = [n] : (!Et || !ue.includes(n)) && ue.push(n));
      else {
        (R.deps ??= []).push(n);
        var r = n.reactions;
...
const Mc = function(n) {
   ...
   */
  decodeString(n, e) {
    return this.HAS_NATIVE_SUPPORT && !e ? atob(n) : Ef(this.decodeStringToByteArray(n, e));
  },
  /**
   * Base64-decode a string.
   *
...
class Ss {
  constructor(e, t) {
    this.shortDelay = e, this.longDelay = t, ct(t > e, "Short delay should be less than long delay!"), this.isMobile = wo() || Vc();
  }
  get() {
...
class mn {
  ...
  async getToken(e, t = !1) {
    return !t && this.accessToken && !this.isExpired ? this.accessToken : (w(
      this.refreshToken,
      e,
      "user-token-expired"
  ...
  static fromJSON(e, t) {
    ...
    return s && (w(typeof s == "string", "internal-error", {
      appName: e
    }), o.refreshToken = s), i && (w(typeof i == "string", "internal-error", {
      appName: e
    }), o.accessToken = i), r && (w(typeof r == "number", "internal-error", {
      appName: e
...
async function ng(n, e, t) {
  ...
  const s = nn(n), o = await Ur(s, {
    ...
    throw l.code === "auth/password-does-not-meet-requirements" && wu(n), l;
...
function sg(n, e, t) {
  return Se(n.app) ? Promise.reject(ot(n)) : tg(ie(n), Wn.credential(e, t)).catch(async (s) => {
    throw s.code === "auth/password-does-not-meet-requirements" && wu(n), s;
  });
}
/**
 * @license
...
function $r() {
  ...
  return new Promise((e, t) => {
    n.addEventListener("error", () => {
      ...
      const s = n.result;
      s.objectStoreNames.contains(ui) ? e(s) : (s.close(), await wg(), e(await $r()));
    });
  });
}
...
class ku {
  ...
  async _get(e) {
    const t = await this._withRetries((s) => Eg(s, e));
...
class dm {
  ...
  async initAndGetManager(e) {
    ...
    return t.register("authEvent", (i) => (w(
      i?.authEvent,
      e,
      "invalid-auth-event"
...
function gm(n) {
  kn(new Kt(
    ...
    (e, { options: t }) => {
      ...
      w(o && !o.includes(":"), "invalid-api-key", { appName: s.name });
      const l = {
        apiKey: o,
        authDomain: a,
        clientPlatform: n,
  ...
  loadJS(n) {
    return new Promise((e, t) => {
      ...
      s.setAttribute("src", n), s.onload = e, s.onerror = (i) => {
        ...
        r.customData = i, t(r);
      }, s.type = "text/javascript", s.charset = "UTF-8", Em().appendChild(s);
    });
  },
 ...
 * limitations under the License.
 */
const wn = new Eo("@firebase/database"), Sm = /* @__PURE__ */ (function() {
  let n = 1;
  return function() {
    return n++;
  };
...
const Rm = function(n, e) {
  _(!0, "Can't turn on custom loggers persistently."), wn.logLevel = M.VERBOSE, ts = wn.log.bind(wn);
}, ne = function(...n) {
...
class di extends Zu {
  ...
  constructor() {
    super(["online"]), this.online_ = !0, typeof window < "u" && typeof window.addEventListener < "u" && !wo() && (window.addEventListener("online", () => {
 ...
 * limitations under the License.
 */
const jn = 1e3, gv = 300 * 1e3, yl = 30 * 1e3, mv = 1.3, vv = 3e4, yv = "server_kill", wl = 3;
class at extends Xu {
  /**
...
Are you using the latest client?`);
  ...
  onAuthRevoked_(e, t) {
    ne("Auth token revoked: " + e + "/" + t), this.authToken_ = null, this.forceTokenRefresh_ = !0, this.realtime_.close(), (e === "invalid_token" || e === "permission_denied") && (this.invalidAuthTokenCount_++, this.invalidAuthTokenCount_ >= wl && (this.reconnectDelay_ = yl, this.authTokenProvider_.notifyForInvalidToken()));
  }
  onAppCheckRevoked_(e, t) {
    ne("App check token revoked: " + e + "/" + t), this.appCheckToken_ = null, this.forceTokenRefresh_ = !0, (e === "invalid_token" || e === "permission_denied") && (this.invalidAppCheckTokenCount_++, this.invalidAppCheckTokenCount_ >= wl && this.appCheckTokenProvider_.notifyForInvalidToken());
  }
...
FIREBASE: `));
  ...
  sendConnectStats_() {
    const e = {};
    let t = "js";
    e["sdk." + t + "." + Pu.replace(/\./g, "-")] = 1, wo() ? e["framework.cordova"] = 1 : Vc() && (e["framework.reactnative"] = 1), this.reportStats(e);
  }
  shouldReconnect_() {
...
class st {
  ...
  addIndex(e, t) {
    _(e !== En, "KeyIndex always exists and isn't meant to be added to the IndexMap.");
    const s = [];
    let i = !1;
...
class E {
  static get EMPTY_NODE() {
    return Gn || (Gn = new E(new ve(Wo), null, st.Default));
  }
  /**
  ...
  /** @inheritDoc */
  updatePriority(e) {
    return this.children_.isEmpty() ? this : new E(this.children_, e, this.indexMap_);
  }
  /** @inheritDoc */
  getImmediateChild(e) {
    if (e === ".priority")
  ...
  val(e) {
    ...
    if (this.forEachChild(G, (o, a) => {
      t[o] = a.val(e), s++, r && E.INTEGER_REGEXP_.test(o) ? i = Math.max(i, Number(o)) : r = !1;
    }), !e && r && i < 2 * s) {
      const o = [];
      for (const a in t)
        o[a] = t[a];
  ...
  withIndex(e) {
      ...
      return this;
    {
      ...
      return new E(this.children_, this.priorityNode_, t);
    }
  }
  isIndexed(e) {
...
class kv extends E {
  constructor() {
    super(new ve(Wo), E.EMPTY_NODE, st.Default);
  }
  compareTo(e) {
    return e === this ? 0 : 1;
  }
...
Object.defineProperties(b, {
  MIN: {
    value: new b(Nn, E.EMPTY_NODE)
  },
  MAX: {
    value: new b(Jt, Os)
  }
});
nh.__EMPTY_NODE = E.EMPTY_NODE;
J.__childrenNodeConstructor = E;
Iv(Os);
bv(Os);
/**
 * @license
...
function Y(n, e = null) {
  ...
  if (!(n instanceof Array) && Av) {
    ...
    if (se(n, (o, a) => {
      ...
      return E.EMPTY_NODE;
    const r = fi(t, Ev, (o) => o.name, Wo);
    if (s) {
      const o = fi(t, G.getCompare());
      return new E(r, Y(e), new st({ ".priority": o }, { ".priority": G }));
    } else
      return new E(r, Y(e), st.Default);
  } else {
    let t = E.EMPTY_NODE;
    return se(n, (s, i) => {
...
class Nv extends Fi {
  ...
  makePost(e, t) {
    const s = Y(e), i = E.EMPTY_NODE.updateChild(this.indexPath_, s);
    return new b(t, i);
  }
  maxPost() {
    const e = E.EMPTY_NODE.updateChild(this.indexPath_, Os);
    return new b(Jt, e);
  }
  toString() {
...
class Bo {
  ...
  updatePriority(e, t) {
    return e.isEmpty() ? E.EMPTY_NODE : e.updatePriority(t);
  }
  filtersNodes() {
    return !1;
  }
...
class ms {
  ...
  updateChild(e, t, s, i, r, o) {
    return this.matches(new b(t, s)) || (s = E.EMPTY_NODE), this.indexedFilter_.updateChild(e, t, s, i, r, o);
  }
  updateFullNode(e, t, s) {
    t.isLeafNode() && (t = E.EMPTY_NODE);
    let i = t.withIndex(this.index_);
    i = i.updatePriority(E.EMPTY_NODE);
    const r = this;
    return t.forEachChild(G, (o, a) => {
      r.matches(new b(o, a)) || (i = i.updateImmediateChild(o, E.EMPTY_NODE));
...
class xv {
  ...
  updateChild(e, t, s, i, r, o) {
    return this.rangedFilter_.matches(new b(t, s)) || (s = E.EMPTY_NODE), e.getImmediateChild(t).equals(s) ? e : e.numChildren() < this.limit_ ? this.rangedFilter_.getIndexedFilter().updateChild(e, t, s, i, r, o) : this.fullLimitUpdateChild_(e, t, s, r, o);
  }
  updateFullNode(e, t, s) {
    let i;
    if (t.isLeafNode() || t.isEmpty())
      i = E.EMPTY_NODE.withIndex(this.index_);
      ...
      i = t.withIndex(this.index_), i = i.updatePriority(E.EMPTY_NODE);
      let r;
      this.reverse_ ? r = i.getReverseIterator(this.index_) : r = i.getIterator(this.index_);
      let o = 0;
      for (; r.hasNext(); ) {
        const a = r.getNext();
        o < this.limit_ && this.withinDirectionalStart(a) && this.withinDirectionalEnd(a) ? o++ : i = i.updateImmediateChild(a.name, E.EMPTY_NODE);
      }
    }
  ...
  fullLimitUpdateChild_(e, t, s, i, r) {
    ...
    if (a.hasChild(t)) {
        ...
        return r?.trackChildChange(gs(t, s, d)), a.updateImmediateChild(t, s);
      {
        ...
        const g = a.updateImmediateChild(t, E.EMPTY_NODE);
        return u != null && this.rangedFilter_.matches(u) ? (r?.trackChildChange(Pn(u.name, u.node)), g.updateImmediateChild(u.name, u.node)) : g;
      }
    } else return s.isEmpty() ? e : h && o(c, l) >= 0 ? (r != null && (r.trackChildChange(_s(c.name, c.node)), r.trackChildChange(Pn(t, s))), a.updateImmediateChild(t, s).updateImmediateChild(c.name, E.EMPTY_NODE)) : e;
  }
}
/**
 * @license
...
function Il(n) {
  ...
  if (n.isDefault())
    return e;
  let t;
  if (n.index_ === G ? t = "$priority" : n.index_ === Ov ? t = "$value" : n.index_ === En ? t = "$key" : (_(n.index_ instanceof Nv, "Unrecognized index type!"), t = n.index_.toString()), e.orderBy = Q(t), n.startSet_) {
...
function dh(n, e, t, s, i) {
  if (!s && !i) {
      ...
      return null;
    {
      ...
      }, a = hh(n.allWrites, o, e), l = t || E.EMPTY_NODE;
      return Dn(a, l);
    }
  }
}
...
function hy(n, e, t, s, i) {
  ...
  if (t.type === Ue.OVERWRITE) {
    const c = t;
    c.source.fromUser ? o = qr(n, e, c.path, c.snap, s, i, r) : (_(c.source.fromServer, "Unknown source."), a = c.source.tagged || e.serverCache.isFiltered() && !T(c.path), o = wi(n, e, c.path, c.snap, s, i, a, r));
    ...
    return e;
  {
    ...
    if (T(t))
      if (_(e.serverCache.isFullyInitialized(), "If change path is empty, we must have complete server data"), e.serverCache.isFiltered()) {
        const c = Zt(e), h = c instanceof E ? c : E.EMPTY_NODE, d = Go(s, h);
  ...
  if (T(t))
    ...
    if (d === ".priority")
      ...
      if (T(u))
        ...
        g != null ? Fo(u) === ".priority" && g.getChild(eh(u)).isEmpty() ? p = g : p = g.updateChild(u, s) : p = E.EMPTY_NODE;
      }
      if (f.equals(p))
        l = e;
      else {
...
function py(n, e, t, s, i, r, o) {
  ...
  if (s.value != null) {
    if (T(t) && l.isFullyInitialized() || l.isCompleteForPath(t))
      return wi(n, e, t, l.getNode().getChild(t), i, r, a, o);
    if (T(t)) {
      let c = new $(null);
      return l.getNode().forEachChild(En, (h, d) => {
        c = c.set(new L(h), d);
      }), Kr(n, e, t, c, i, r, a, o);
    } else
      return e;
    ...
    return e;
  {
    ...
    if (T(t) || C(t) === ".priority") {
      ...
      if (e.serverCache.isFullyInitialized())
        ...
        _(d instanceof E, "serverChildren would be complete if leaf node"), h = Go(s, d);
      }
      h = h, c = n.filter.updateFullNode(l, h, r);
    } else {
      const h = C(t);
      let d = qo(s, h, e.serverCache);
      d == null && e.serverCache.isCompleteForChild(h) && (d = l.getImmediateChild(h)), d != null ? c = n.filter.updateChild(l, h, d, W(t), a, r) : e.eventCache.getNode().hasChild(h) ? c = n.filter.updateChild(l, h, E.EMPTY_NODE, W(t), a, r) : c = l, c.isEmpty() && e.serverCache.isFullyInitialized() && (o = vi(s, Zt(e)), o.isLeafNode() && (c = n.filter.updateFullNode(c, o, r)));
    }
...
class my {
  constructor(e, t) {
    ...
    const o = t.serverCache, a = t.eventCache, l = i.updateFullNode(E.EMPTY_NODE, o.getNode(), null), c = r.updateFullNode(E.EMPTY_NODE, a.getNode(), null), h = new Nt(l, o.isFullyInitialized(), i.filtersNodes()), d = new Nt(c, a.isFullyInitialized(), r.filtersNodes());
...
function Cy(n) {
  _(!Ei, "__referenceConstructor has already been defined"), Ei = n;
}
function by() {
  return _(Ei, "Reference.ts has not been loaded"), Ei;
}
function Ty(n) {
...
function yh(n, e, t, s, i) {
  ...
  if (!o) {
    ...
    a ? l = !0 : s instanceof E ? (a = Go(t, s), l = !1) : (a = E.EMPTY_NODE, l = !1);
...
function Sy(n, e, t, s, i, r) {
  ...
  return n.views.has(e._queryIdentifier) || n.views.set(e._queryIdentifier, o), Ey(o, t), Iy(o, t);
}
function Ry(n, e, t, s) {
...
function Yr(n, e, t, s = !1) {
  ...
  let l;
  r != null ? l = !0 : (l = !1, r = E.EMPTY_NODE, n.syncPointTree_.subtree(i).foreachChild((f, p) => {
    const g = kt(p, k());
...
function Ly(n, e) {
  ...
  const r = s != null, o = r ? new Nt(s, !0, !1) : null, a = $i(n.pendingWriteTree_, e._path), l = yh(i, e, a, r ? o.getNode() : E.EMPTY_NODE, r);
  return yy(l);
}
function Hn(n, e) {
  return Th(
...
function Wy(n, e, t) {
  ...
  if (i)
    ...
    const l = a.fold((c, h, d) => {
      ...
      {
        let u = [];
        return h && (u = u.concat(wh(h).map((f) => f.query))), se(d, (f, p) => {
          u = u.concat(p);
        }), u;
      }
    });
 ...
 * limitations under the License.
 */
const qy = /[\[\].#$\/\u0000-\u001F\u007F]/, Ky = /[\[\].#$\u0000-\u001F\u007F]/, wr = 10 * 1024 * 1024, ra = function(n) {
  ...
  if (typeof e == "string" && e.length > wr / 3 && Di(e) > wr)
    throw new Error(n + "contains a string greater than " + wr + " utf8 bytes " + Ut(s) + " ('" + e.substring(0, 50) + "...')");
...
function Fh(n, e) {
  ...
  for (let s = 0; s < n.eventLists_.length; s++) {
    ...
    if (i) {
      const r = i.path;
      e(r) ? (nw(n.eventLists_[s]), n.eventLists_[s] = null) : t = !1;
    }
  }
 ...
 * limitations under the License.
 */
const sw = "repo_interrupt", iw = 25;
class rw {
  constructor(e, t, s, i) {
    this.repoInfo_ = e, this.forceRestClient_ = t, this.authTokenProvider_ = s, this.appCheckProvider_ = i, this.dataUpdateCount = 0, this.statsListener_ = null, this.eventQueue_ = new tw(), this.nextWriteId_ = 1, this.interceptServerDataCallback_ = null, this.onDisconnect_ = _i(), this.transactionQueueTree_ = new sa(), this.persistentConnection_ = null, this.key = this.repoInfo_.toURLString();
  }
  /**
...
function fw(n) {
  n.persistentConnection_ && n.persistentConnection_.interrupt(sw);
}
function Ms(n, ...e) {
  let t = "";
...
function $h(n, e, t) {
  return Qo(n.serverSyncTree_, e, t) || E.EMPTY_NODE;
}
...
const Fl = function(n, e) {
  ...
  if (typeof n == "string") {
    ...
    h === -1 && (h = n.length);
    let d = n.indexOf("?");
    d === -1 && (d = n.length), e = n.substring(0, Math.min(h, d)), h < d && (i = gw(n.substring(h, d)));
    const u = mw(n.substring(Math.min(n.length, d)));
 ...
 * limitations under the License.
 */
const Ul = "-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz", yw = /* @__PURE__ */ (function() {
  let n = 0;
  const e = [];
  return function(t) {
    const s = t === n;
...
class ws {
   ...
   */
  child(e) {
    const t = new L(e), s = Es(this.ref, e);
    return new ws(this._node.getChild(t), s, G);
  }
  /**
   ...
   */
  forEach(e) {
    return this._node.isLeafNode() ? !1 : !!this._node.forEachChild(this._index, (s, i) => e(new ws(i, Es(this.ref, s), G)));
  }
  /**
...
function qe(n, e) {
  return n = ie(n), n._checkNotDeleted("ref"), e !== void 0 ? Es(n._root, e) : n._root;
}
function Es(n, e) {
...
function Iw(n, e) {
  ...
  const t = Uh(n._repo), s = yw(t), i = Es(n, s), r = Es(n, s);
  let o;
...
function Zr(n, e) {
  Xy("update", e, n._path);
  const t = new bs();
  return uw(n._repo, n._path, e, t.wrapCallback(() => {
  })), t.promise;
}
function bw(n) {
  n = ie(n);
  ...
  return lw(n._repo, n, t).then((s) => new ws(s, new _t(n._repo, n._path), n._queryParams.getIndex()));
}
class Ki {
  constructor(e) {
  ...
  createEvent(e, t) {
    ...
    return new ww("value", this, new ws(e.snapshotNode, new _t(t._repo, t._path), s));
  }
  getEventRunner(e) {
  ...
  createCancelEvent(e, t) {
    return this.callbackContext.hasCancelCallback ? new Ew(this, e, t) : null;
  }
  matches(e) {
...
function Tw(n, e, t, s, i) {
  ...
  return dw(n._repo, n, a), () => Jr(n._repo, n, a);
}
function bi(n, e, t, s) {
  return Tw(n, "value", e, t, s);
}
function da(n, e, t) {
  Jr(n._repo, n, null);
}
 ...
 * limitations under the License.
 */
const Sw = "FIREBASE_DATABASE_EMULATOR_HOST", eo = {};
let Rw = !1;
function kw(n, e, t, s) {
...
function Aw(n, e, t, s, i) {
  ...
  typeof process < "u" && process.env && (l = process.env[Sw]), l ? (r = `http://${l}?ns=${a.namespace}`, o = Fl(r, i), a = o.repoInfo) : o.repoInfo.secure;
  const c = new $m(n.name, n.options, e);
  ew("Invalid Firebase Database URL", o), T(o.path) || ut("Database URL must point to the root of a Firebase Database (not including a child path).");
  const h = Pw(a, n, c, new Um(n, t));
  return new Ow(h, n);
}
function Nw(n, e) {
  const t = eo[e];
  (!t || t[n.key] !== n) && ut(`Database ${e}(${n.repoInfo_}) has already been deleted.`), fw(n), delete t[n.key];
}
function Pw(n, e, t, s) {
  let i = eo[e.name];
  i || (i = {}, eo[e.name] = i);
  let r = i[n.toURLString()];
  return r && ut("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."), r = new rw(n, Rw, t, s), i[n.toURLString()] = r, r;
}
class Ow {
  /** @hideconstructor */
  constructor(e, t) {
  ...
  get _repo() {
    return this._instanceStarted || (ow(this._repoInternal, this.app.options.appId, this.app.options.databaseAuthVariableOverride), this._instanceStarted = !0), this._repoInternal;
  }
  get _root() {
    return this._rootInternal || (this._rootInternal = new _t(this._repo, k())), this._rootInternal;
  }
  _delete() {
    return this._rootInternal !== null && (Nw(this._repo, this.app.name), this._repoInternal = null, this._rootInternal = null), Promise.resolve();
  }
  _checkNotDeleted(e) {
...
function xw(n, e, t, s = {}) {
  ...
  Fn(e) && (Bc(e), Hc("Database", !0)), kw(r, i, s, o);
}
/**
 * @license
 * Copyright 2021 Google LLC
...
}, zh = qc(Lw), Yi = wm(zh), Ke = Dw(zh), Fw = mo(null), Uw = mo(!0);
lg(Yi, (n) => {
  Fw.set(n), Uw.set(!1);
});
...
function jw(n, e) {
  ...
  async function l(q) {
    ...
    let U;
    if (y(a) ? U = await Ww(y(t), y(s), y(i)) : U = await $w(y(t), y(s)), U.success) {
  ...
  var h = Vw(), d = z(h), u = z(d), f = z(u, !0);
  B(u);
  var p = ge(u, 2), g = z(p);
  {
    var v = (q) => {
      var U = Bw(), ee = ge(z(U), 2);
...
Sc(["click"]);
customElements.define("login-form", Dc(jw, {}, [], [], !0));
var Gw = /* @__PURE__ */ He('<div class="loading svelte-1t1odzy"><div class="spinner svelte-1t1odzy"></div> <p class="svelte-1t1odzy">게시물을 불러오는 중...</p></div>'), qw = /* @__PURE__ */ He('<div class="error svelte-1t1odzy"><p class="svelte-1t1odzy"> </p></div>'), Kw = /* @__PURE__ */ He('<div class="empty svelte-1t1odzy"><p class="svelte-1t1odzy">아직 게시물이 없습니다.</p></div>'), Yw = /* @__PURE__ */ He('<h3 class="post-title svelte-1t1odzy"> </h3>'), Qw = /* @__PURE__ */ He('<p class="post-text svelte-1t1odzy"> </p>'), Jw = /* @__PURE__ */ He('<article class="post-card svelte-1t1odzy" role="button" tabindex="0"><div class="post-header svelte-1t1odzy"><div class="author-info svelte-1t1odzy"><span class="author-name svelte-1t1odzy"> </span> <span class="post-date svelte-1t1odzy"> </span></div></div> <div class="post-content svelte-1t1odzy"><!> <!></div> <div class="post-footer svelte-1t1odzy"><span class="stat svelte-1t1odzy"> </span> <span class="stat svelte-1t1odzy"> </span></div></article>'), Xw = /* @__PURE__ */ He('<div class="posts svelte-1t1odzy"></div>'), Zw = /* @__PURE__ */ He('<div class="post-list-container svelte-1t1odzy"><!></div>');
const eE = {
  hash: "svelte-1t1odzy",
  code: `
...
Sc(["click", "keydown"]);
customElements.define("post-list", Dc(tE, { path: {}, limit: {} }, [], [], !0));
function iE(n) {
