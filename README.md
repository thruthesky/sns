# 🚀 SNS - 바이브 코딩을 통한 소셜 서비스 웹/앱 개발 스터디 프로젝트

> AI와 함께하는 협업 개발 경험, 코딩 없이 만드는 실전 웹 애플리케이션
> 진행중인 공동 프로젝트 보기: [vibers.kr](https://vibers.kr)
> 2025년 11월 2일: 프로젝트 변경. 기존의 Next.js + Supabase 기반 SNS 웹/앱 개발에서 SvelteKit + Flutter 기반 SNS 웹/앱 개발로 전환. 이유: 돈을 벌기 위해서 현재 진행중인 프로젝트에 맞는 (직접 적용 가능한) 프로젝트로 변경.
...
- ✅ Firebase 같은 백엔드 서비스를 배우고 싶으신 분
- ✅ SvelteKit, Flutter 기반 모던 웹 개발을 경험하고 싶으신 분
...
### 백엔드 & 데이터베이스
- **Firebase** - 인증, Realtime Database, Firestore, Cloud Functions

### 모바일 앱
- **Flutter** - SvelteKit API를 통해 웹과 동일한 수준의 UI/UX를 제공하는 크로스플랫폼 앱 개발
  - iOS/Android 동시 지원
  - 웹과 동일한 Firebase 인증 사용

### 개발 도구

개발 도구는 자유롭게 선택 가능합니다. 다만, 아래 도구들을 권장합니다.

- **VS Code** - 주요 개발 환경 (IDE)
- **Git & GitHub** - 버전 관리 및 협업
- **AI 개발 도구** - AI 기반 개발 도구

<br/>

## 🎨 구현된/예정된 기능

- 프로덕션 서비스에 쓸 수 있는 완전한, 지속 가능한 SNS 웹/앱 개발 프로젝트
